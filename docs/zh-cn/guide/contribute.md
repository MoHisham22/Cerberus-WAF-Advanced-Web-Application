...
- 规则提交位置: https://github.com/Safe3/uusec-waf/tree/master/rules
- 插件提交位置: https://github.com/Safe3/uusec-waf/tree/master/plugins
...
?> 参与贡献即可获得与南墙社区版内部大佬技术切磋交流的机会。提交 PR 过程中会有内部大佬审核，帮助改进规则和插件，共同进步。

- 提交一个规则或插件即可进入南墙核心贡献者群，参与讨论热点安全技术，且有机会与大佬们面对面交流。
- 对于南墙商业版年费用户，在当年的商业版授权有效期内，只需在提交5个插件或规则，即可再免费续一年商业升级。
